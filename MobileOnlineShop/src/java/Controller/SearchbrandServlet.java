 ...
 * @author Admin
 */
@WebServlet(name = "SearchbrandServlet", urlPatterns = {"/SearchbrandServlet"})
public class SearchbrandServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            session.setAttribute("rediPage", request.getRequestURI().toString() + "?brandid=" + brandid);
            request.setAttribute("listbrand", brandsFacade.findAll());
            request.setAttribute("listproduct", productsFacade.findProductbyBrand(cateid, brandid));
